<template>
  <div
    class="bg-white mx-3 rounded-md w-96 shadow-lg max-h-[80vh] overflow-y-auto modal-container"
  >
    <!-- Header -->
    <div
              ...
              <div class="flex items-center group">
                ...
                <label for="terms" class="flex items-center cursor-pointer">
                  ...
                  <label for="terms" class="ml-3 text-sm text-gray-700">
                    J'accepte les
                    <span class="font-medium text-[#e4097f]">termes </span>
                  </label>
                </label>
              </div>
            </div>
...
const handleSubmit = async () => {
  try {
    ...
    if (response && response.success) {
      ...
      router.push({ name: "list_agrement" });
    }
  } catch (e) {
    console.log(e);
  }
