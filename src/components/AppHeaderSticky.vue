    ...
    <header
        ...
        <div class="container flex items-center justify-between px-4 mx-auto">
            ...
            <div class="items-center hidden space-x-4 md:flex">
                ...
                <button v-if="!isAuthentified"
                    class="bg-[#e4097f] hover:bg-[#c8076f] text-white text-sm font-medium px-4 py-2 rounded transition-colors">
                    Log In
                </button>
         ...
         <div class="px-8 py-4 space-y-4 bg-white">
          ...
          <div class="pt-4 border-t border-gray-100">
            <div v-if="!isAuthentified" class="space-y-3">
              ...
              <button 
                @click="closeMobileMenu"
                class="w-full bg-[#e4097f] hover:bg-[#c8076f] text-white text-sm font-medium px-4 py-2 rounded transition-colors"
              >
                Log In
              </button>
            </div>
