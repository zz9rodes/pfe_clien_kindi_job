    ...
    <form @submit.prevent="SaveCompanieChange" class="space-y-8">
      <div class="flex gap-3">
        ...
        >
         ...
         <button
         @click.prevent="SaveCompanieChange"
          class="bg-[#db147f] text-white px-6 py-2 rounded-lg hover:bg-[#c01370] transition-colors"
        >
          <Save class="sm:hidden" />
          <span class="hidden sm:block"> Save Changes </span>
      ...
      <div class="p-6 bg-white border rounded-lg">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="flex items-center space-x-4">
              <div class="w-20 h-20 rounded-lg">
                <img
                  ...
                  v-if="companyForm.avatarUrl"
                  :src="companyForm.avatarUrl"
                  alt=""
                />
                <div
                  v-else
          ...
          <div>
            ...
            <label
              for="cover_image"
              class="block mb-3 text-sm font-medium text-gray-700 cursor-pointer"
            >
      ...
      <div class="p-6 bg-white border rounded-lg">
        <h3
          class="flex items-center justify-between mb-6 text-lg font-medium text-gray-900"
        >
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div>
            ...
            >
            <select
              v-model="companyForm.firstLangage"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#db147f] outline-none focus:border-transparent"
              required
            >
          ...
          <div>
            ...
            >
            <input
              v-model="companyForm.socialStatus"
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#db147f] outline-none focus:border-transparent"
...
const SaveCompanieChange = async() => {
  ...
  const data= await auth.api('post','/company_request/create',companyForm.value)
