      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:space-x-8">
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          <div class="flex flex-wrap justify-center gap-2 mb-4 lg:justify-start">
            <span v-if="userAccount.account?.firstLangage" class="px-3 py-1 text-sm font-medium text-blue-800 bg-blue-100 rounded-full">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
      ...
      <div class="p-6 bg-white shadow-sm rounded-2xl lg:p-8">
        ...
        <div class="space-y-6">
          ...
          <div>
            <label class="block mb-2 text-sm font-medium tracking-wide text-gray-500 uppercase">Date de naissance</label>
            <p class="text-lg font-semibold text-gray-900">
          ...
          <div>
            <label class="block mb-2 text-sm font-medium tracking-wide text-gray-500 uppercase">Numéro de téléphone</label>
            <p class="text-lg font-semibold text-gray-900">
      ...
      <div class="p-6 bg-white shadow-sm rounded-2xl lg:p-8">
        ...
        <div class="space-y-6">
          <div>
            <label class="block mb-2 text-sm font-medium tracking-wide text-gray-500 uppercase">Langue principale</label>
          ...
          <div v-if="userAccount.account?.secondLangage">
            <label class="block mb-2 text-sm font-medium tracking-wide text-gray-500 uppercase">Langue secondaire</label>
            <div class="flex items-center">
