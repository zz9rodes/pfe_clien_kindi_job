<template>
  <div v-if="userAccount" class="flex flex-col px-4 mx-auto w-full">
    <!-- Modals -->
    ...
    <div class="flex flex-col mb-8 sm:flex-row sm:items-center sm:justify-between lg:mb-10">
      ...
      <button @click="toggleOpenModal()"
        ...
        <svg class="inline mr-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-6 mb-8 bg-white rounded-2xl shadow-sm lg:p-8">
      <div class="flex flex-col lg:flex-row lg:items-center lg:space-x-8">
          ...
          <div class="relative">
            <div class="inline-block relative">
              <img v-if="userAccount.account?.avatarUrl"
                ...
                class="object-cover w-32 h-32 rounded-full border-4 border-white shadow-sm lg:w-40 lg:h-40" />
              <div v-else
                class="flex justify-center items-center w-32 h-32 bg-gray-200 rounded-full border-4 border-white shadow-sm lg:w-40 lg:h-40">
        ...
        <div class="flex-1 text-center lg:text-left">
          ...
          <!-- Badges -->
          <div class="flex flex-wrap gap-2 justify-center mb-4 lg:justify-start">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
      ...
      <div class="p-6 bg-white rounded-2xl shadow-sm lg:p-8">
      ...
      <div class="p-6 bg-white rounded-2xl shadow-sm lg:p-8">
        <div class="flex items-center mb-6">
          <div class="p-2 mr-3 bg-blue-500 bg-opacity-10 rounded-lg">
      ...
      <div class="p-6 bg-white rounded-2xl shadow-sm lg:p-8">
        <div class="flex items-center mb-6">
          <div class="p-2 mr-3 bg-green-500 bg-opacity-10 rounded-lg">
      ...
      <div class="p-6 bg-white rounded-2xl shadow-sm lg:p-8">
        <div class="flex items-center mb-6">
          <div class="p-2 mr-3 bg-purple-500 bg-opacity-10 rounded-lg">
