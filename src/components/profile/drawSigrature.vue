    ...
    <div class="max-w-4xl mx-auto">
        <div class="p-8 bg-white border rounded-lg">
            <div class="mb-8 text-center">
                ...
                <h2 class="mb-2 text-2xl font-semibold text-gray-900">Digital Signature</h2>
                <p class="text-gray-600">Please provide your name and signature below</p>
            </div>
            ...
            <form @submit.prevent="saveSignature" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="p-6 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50">
                        <div
                            ...
                            <input type="text"  v-model="signatureForm.typedSignature" :style="{ fontFamily: signatureForm.font }"
                ...
                <div class="flex justify-end pt-6 space-x-4">
                    ...
                    <button type="submit" :disabled="!signatureForm.name  || !signatureForm.typedSignature"
                        class="px-6 py-2 bg-[#db147f] text-white rounded-lg hover:bg-[#c01370] transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                        Save Signature
                    </button>
                </div>
            </form>
