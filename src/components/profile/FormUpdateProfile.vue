            ...
            <div class="flex-1 p-6 space-y-6 overflow-auto ">
                <div class="relative space-y-2">
                    ...
                    <input id="email" v-model="formData.email" type="email" placeholder="john.doe@company.com"
                        ...
                        required />
                    <span class="absolute top-[90%] left-0 text-sm text-red-600" v-if="formErrors.email">{{
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2 required:">
                        ...
                        <input id="firstName" v-model="formData.firstName" placeholder="John"
                            class="w-full px-4 py-2 transition-colors border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#e4097f]"
                            required />
                        <span class="absolute top-[90%] left-0 text-sm text-red-600" v-if="formErrors.firstName">{{
                    ...
                    <div class="relative space-y-2">
                        ...
                        <input id="lastName" v-model="formData.lastName" placeholder="Doe"
                            class="w-full px-4 py-2 transition-colors border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#e4097f]"
                            required />
                        <span class="absolute top-[90%] left-0 text-sm text-red-600" v-if="formErrors.lastName">{{
                ...
                <div class="relative space-y-2">
                    ...
                    <input id="phoneNumber" v-model="formData.phoneNumber" type="tel" placeholder="+1234567890"
                        class="w-full px-4 py-2 transition-colors border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#e4097f]"
                        required />
                    <span class="absolute top-[90%] left-0 text-sm text-red-600" v-if="formErrors.phoneNumber">{{
                ...
                <div class="space-y-6 ">
                    <div class="relative space-y-2 mt-7">
                        ...
                        <input id="city" v-model="formData.country" placeholder="Yaoundé, Douala, Bamenda..."
                            class="w-full px-4 py-2 transition-colors border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#e4097f]" />
                        <span class="absolute top-[90%] left-0 text-sm text-red-600" v-if="formErrors.country">{{
                    ...
                    <div class="relative space-y-2">
                        ...
                        <span class="text-sm text-red-600 absolute top-[90%] left-0 "
                            v-if="formErrors.city">{{ formErrors.city[0] }}</span>
                    </div>
                    ...
                    <div class="relative space-y-2">
                        ...
                        <input id="address" v-model="formData.address" placeholder="123 Main St, Yaoundé, Cameroon"
                            class="w-full px-4 py-2 transition-colors border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-[#e4097f]" />
                        <span class="text-sm text-red-600 absolute top-[90%] left-0 "
...
const formData = ref(props.accountProfile);
