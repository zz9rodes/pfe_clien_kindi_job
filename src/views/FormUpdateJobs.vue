  ...
  <div class="w-full min-h-screen bg-gray-50">
    <div  class="max-w-4xl p-6 mx-auto">
      ...
      <div class="space-y-6">
            ...
            <div v-if="imagePreview" class="space-y-4">
              ...
              <div class="flex items-center justify-between p-4 rounded-lg bg-gray-50">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="font-medium text-gray-900">{{ selectedImage?.name || 'Image existante' }}</p>
                    <p class="text-sm text-gray-600">{{ selectedImage ? (selectedImage.size / 1024 / 1024).toFixed(2) + ' MB' : 'Taille inconnue' }}</p>
                  </div>
                </div>
                <button
                  @click="triggerFileInput"
        ...
        <!-- Statut -->
        <div class="p-6 bg-white border border-gray-200 rounded-lg">
          <h2 class="mb-4 text-xl font-semibold text-gray-900">Statut de l'offre</h2>
          <div>
...
const fetchJobData = async () => {
    let jobId=3
  try {
    // Appel API pour récupérer les données du job
    ...
    // Initialisation des données du job
 jobData.value = {
  id: 123,
